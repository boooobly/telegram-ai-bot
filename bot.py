...
LIFE_BEST = [
    ...
    "cymath.com — Реши любое математическое уравнение (не работает)",
    ...
    "aistudio.google.com — Десятки инструментов для работы с ИИ",
    ...
    "luxa.org — Десятки инструментов для работы с изображениями",
    ...
    "blueprint.am — Создай любое устройство с нуля",
    "supercook.com — Соберет сотни рецептов из того, что есть в холодильнике",
    "web.archive.org — Узнай, как сайты выглядели в прошлом",
    ...
    "chemequations.com — Реши любые химические уравнения",
    "thetruesize.com — Проверь реальный размер страны",
    "liquidationdomains.com — Домены на любой вкус",
    "bratuha.ru — Один из лучших агрегаторов нейросетей",
    "app.sesame.com — Выучи английский общаясь с нейронкой",
    "dimensions.com — Огромная библиотека данных по любым предметам, личностям, технике и др.",
    "easyedit.io — Онлайн-редактор текстом фото с AI",
    "app.topoexport.com — Создавай карту местности в пару кликов",
    ...
    "styles.refero.design — Больше 2000 стилей сайтов для вайбкодинга. spoteeq.ru — Сервис для пополнения зарубежных сервисов",
    "proboi.site — Личный ИИ ассистент",
    ...
    "dialed.gg — Игра где нужно подбирать цвета, проверять свой глазомер и слух",
    "paperme.pixzens.com — Любой тип разметки для бумаги",
    "malmap.net — Найди, что посмотреть из аниме",
    "anitabi.cn/map — Реальные места на карте из аниме",
    "aicameramovements.com — Готовые промпты для управления камерой, как в фильмах",
    "delphi.tools — Бесплатные браузерные инструменты для изображений, шрифтов, цветов",
    ...
    "originkit.dev — Библиотека бесплатных анимированных компонентов",
    "3dsvg.design — Загружай логотип, анимируй, создавай его в 3D",
    ...
    "window-swap.com — Посмотри на жизнь из чужого окна",
    "shipthatcode.com — Изучай программирование на реальных кейсах",
    "1) zapsplat.com — Библиотека SFX эффектов. 2) eyecannndy.com — библиотека визуальных приёмов и референсов для видео. 3) mixkit.co — видео, аудио и фото стоки",
    "holocloth.vercel.app — Эффектная подача своей работы в виде реалистичной ткани",
    "floor796.com — Пиксельный мир из мемов, сериалов, отсылок, аниме и фильмов",
    "alternativeto.net — Поисковик альтернативных приложений и софта",
    "tools.dverso.io/bgremove — Милое удаление фона",
    "tolk.bot — AI сервис для поиска товаров на маркетплейсах",
    "buildcores.com — Собери свой ПК с 3D визуализацией, производительностью и примерной стоимостью",
    ...
    "recent.design — ежедневная подборка дизайн-референсов, сайтов и инструментов",
]
